...
pub fn build(b: *std.Build) void {
    ...
    const templates_step = zt.addTemplates(
        ...
        &.{
            ...
            b.path("src/templates/source_field.zt"),
            b.path("src/templates/compensation.zt"),
            b.path("src/templates/company_questions.zt"),
            b.path("src/templates/process_form.zt"),
            b.path("src/templates/process_detail.zt"),
            b.path("src/templates/stage_card.zt"),
            b.path("src/templates/stage_timeline.zt"),
    ...
    const handwritten_zig_sources = &.{
        "build.zig",
        "src/assets.zig",
        "src/appointments.zig",
        "src/config.zig",
        "src/compensations.zig",
        "src/database.zig",
        "src/main.zig",
        "src/migrations.zig",
        "src/notes.zig",
